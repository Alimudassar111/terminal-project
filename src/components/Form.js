...
class Form extends Component {
  ...
  render() {
    ...
    return (
      <form className="form-horizontal guestbook__form"
        ...
        <div className={`form-group ${comment.touched && comment.invalid ? 'has-error' : ''}`}>
          <label htmlFor="comment" className="col-md-2 control-label">Address:</label>
          <div className="col-md-10">
            <input {...comment} className="form-control"></input>
            <div className="help-block">
